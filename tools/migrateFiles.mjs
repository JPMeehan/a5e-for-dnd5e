...
function mapSource(src) {
  ...
  const sourceMap = {
    acesAdventuringGuideToNecromancy: "AAGtN",
    acesAdventuringGuideToNecromancySupplement: "AAGtN:S",
    advancedArtificers: "AA",
    adventurersGuide: "AG",
    adventuresInZeitgeist: "AiZ",
    agentOfTheMagus: "AotM",
    arcaneSniper: "AS",
    confidenceMage: "ConfMage",
    deepMagic1: "DM Vol.1",
    deepMagic2: "DM Vol.2",
    doseOfDungeonpunk: "DOD:TH",
    dungeonDelversGuide: "DDG",
    extraCreditAndDeeperMysteries: "ECaDM",
    fieldEngineer: "FE",
    fieryJustice: "FJ",
    gpg0: "GPG #0",
    gpg1: "GPG #1",
    ...
    gpg20: "GPG #20",
    gpg21: "GPG #21",
    hakansPamphlet: "HPtAW",
    hearthAndHome: "HaH",
    heroesOldAndNew: "HOaN",
    moarComplete: "MoAR",
    monstrousMenagerie: "MoMe",
    mortalist: "Mort",
    motifClasses: "SA:MC",
    multiclassersManual: "MulMan Vol. 1",
    mysteriousAndMarvelousMiscellanea: "MMM",
    paradigmsOfSkill: "PoS",
    planestridersJournal: "PJ",
    ridingParsnip: "RP",
    secretsOfTheSelkies: "SotS",
    sinuousSentinels: "SinSen",
    spellsFromTheForgottenVault: "SftFV",
    spiritualist: "Spirit",
    strangerSights: "SS",
    theHauntingOfCalrowRuins: "THoCR",
    thematicToolkitArcaneAvenger: "TT:AA",
    thematicToolkitBurningGloom: "TT:BG",
    thematicToolkitCarryTheDarkness: "TT:CtD",
    thematicToolkitCultist: "TT:Cult",
    thematicToolkitFolkOfTheCourt: "TT:FotC",
    thematicToolkitHazardousKnowledge: "TT:HK",
    thematicToolkitItinerant: "TT:Itin",
    thematicToolkitJudgeJuryAndExecutioner: "TT:JJE",
    thematicToolkitMasterOfCeremonies: "TT:MoC",
    thematicToolkitScrapper: "TT:Scrap",
    thematicToolkitStoryteller: "TT:Story",
    thematicToolkitThunderOfWar: "TT:ToW",
    thematicToolkitVenomousShadow: "TT:VS",
    theErrantSeer: "TES",
    theRuinStrider: "TRS",
    theSpellbreaker: "TS",
    toilAndTrouble: "TaT",
    toSaveAKingdom: "TSaK",
    trialsAndTreasures: "T&T",
    ventureForth: "VF"
  };
...
function getBaseItem(name, type) {
  ...
  if (name in nameMap[type]) return nameMap[type][name];
